...
function toRow(
  ...
  modeSolves?: Record<SolveMode, number>,
): Row {
  return {
    rank: i + 1,
    userId: r.userId,
...
export const leaderboard = query({
  args: { period: v.optional(v.union(v.literal("all"), v.literal("week"))) },
